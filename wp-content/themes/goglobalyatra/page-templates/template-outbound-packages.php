<?php
/**
 * Template Name: Outbound Packages
 */
get_header();
get_template_part('template-parts/page-hero', null, [
    'title' => 'Outbound Packages',
    'subtitle' => 'International tours for Nepali travelers with complete booking support.',
]);
...
<main>
  <section class="max-w-7xl mx-auto px-4 py-14">
    ...
    <?php else : ?>
      <p class="text-slate-600">No outbound packages available right now. Please check back soon.</p>
    <?php endif; ?>
  </section>
</main>
<?php get_footer(); ?>
